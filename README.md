# Система генерации отчетов заключений экспертизы с умным поиском по строительным нормативам
...
Датасет строительных нормативов: Russian Construction Standards Dataset (https://github.com/Akumsk/russian-construction-standards). В проекте используются JSON-файлы с текстами нормативов. Данные распространяются под лицензией CC BY 4.0.
